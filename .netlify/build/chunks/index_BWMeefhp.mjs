...
const $$BlogHome = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let allPost = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../pages/posts/actualidad/index.md": () => import('./index_CwbTEj8E.mjs'),"../../pages/posts/actualidad/post2.md": () => import('./post2_CnDZW4rL.mjs'),"../../pages/posts/recetas/atollado.md": () => import('./atollado_LXjSZY8O.mjs'),"../../pages/posts/recetas/index.md": () => import('./index_D25AA-v0.mjs')}), () => "../../pages/posts/**/*.md");
