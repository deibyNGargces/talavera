...
import 'kleur/colors';
import { $ as $$SlideComponent } from './SlideComponent_BXQTUgsD.mjs';
...
new Proxy({"src":"/_astro/vaca.WPuenyIz.gif","width":640,"height":640,"format":"gif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/USUARIO/OneDrive/Documentos/PixelFox/Talavera/talavera/src/assets/images/vaca.gif";
							}
...
const vacavideo$1 = "/_astro/vaca.BhFrKcX8.mp4";

const APIURL$1 = `${BACKENDURL}`;
const Modal = ({ idProduct, token, onClose }) => {
  ...
  const getProduct = async (id2) => {
    await fetch(`${APIURL$1}/index.php?action=product&id=${id2}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer tu_token_aqui"
      }
    }).then((response) => response.json()).then((data) => setProduct(data)).catch((error) => console.log("error", error));
    setLoading(false);
  };
  const {
    imagen_url: image,
 ...
 del producto: ${name}
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-white max-w-screen-xl w-full rounded-lg shadow-lg p-8 py-12 relative", children: [
    ...
    // Si la información del producto no ha sido cargada
    loading ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center", children: [
      /* @__PURE__ */ jsx("video", { src: vacavideo$1, autoPlay: true, loop: true, muted: true, className: "w-20 h-20" }),
      /* @__PURE__ */ jsx("p", { className: "text-xl lg:text-4xl text-center", children: "Buscando tu producto..." })
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-between gap-6 max-h-max", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row justify-end gap-4 lg:gap-8 ", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
...
const vacavideo = "/_astro/ordeno.fjJx9Fn_.mp4";
...
const ProductsSection = ({ category }) => {
  ...
  const getCategories = async () => {
    ...
    }).then((response) => response.json()).then((data) => categorias = data).catch((error) => console.log("error", error));
  ...
  const getproducts = async (token2) => {
    ...
    ).then((response) => response.json()).then((data) => setProducts(data)).catch((error) => console.log("error", error));
    setLoading(false);
  };
  const handleOpen = (id) => {
    setIdProduct(id);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "max-w-screen-xl p-2 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8  ", children: [
    loading ? /* @__PURE__ */ jsxs("div", { className: "col-span-full h-full flex items-center justify-center  ", children: [
      /* @__PURE__ */ jsx("video", { src: vacavideo, autoPlay: true, loop: true, muted: true, className: "w-20 h-20" }),
      /* @__PURE__ */ jsx("p", { className: "text-2xl lg:text-4xl text-center", children: "Cargando productos..." })
    ] }) : products?.length === 0 || !products ? /* @__PURE__ */ jsx("div", { className: "col-span-full h-full flex items-center justify-center ", children: /* @__PURE__ */ jsx("p", { className: "text-2xl lg:text-4xl text-center", children: "No hay productos dentro de esta categoria" }) }) : products.error ? /* @__PURE__ */ jsx("div", { className: "col-span-full h-full flex items-center justify-center ", children: /* @__PURE__ */ jsx("p", { className: "text-2xl lg:text-4xl text-center", children: products.message }) }) : products?.map((product) => /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-lg text-center mb-2 font-bold", children: product.nombre }),
            /* @__PURE__ */ jsx(
              "button",
              {
...
const $$ProductsComponent = createComponent(async ($$result, $$props, $$slots) => {
  ...
  try {
    ...
    console.error("Error al obtener las categor\xEDas");
  }
