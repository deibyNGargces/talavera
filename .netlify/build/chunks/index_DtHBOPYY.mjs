...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  let allPost = await Astro2.glob(/* #__PURE__ */ Object.assign({"../posts/actualidad/index.md": () => import('./index_DUU_gCo9.mjs'),"../posts/actualidad/post2.md": () => import('./post2_Cv3l2akI.mjs'),"../posts/recetas/atollado.md": () => import('./atollado_Is36rawe.mjs'),"../posts/recetas/index.md": () => import('./index_CqSYUaWV.mjs')}), () => "../posts/**/*.md");
